...
def test_device_manager_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    DeviceManagerClient, DeviceManagerAsyncClient
])
@mock.patch.object(DeviceManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DeviceManagerClient))
@mock.patch.object(DeviceManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DeviceManagerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DeviceManagerClient, transports.DeviceManagerGrpcTransport, "grpc", grpc_helpers),
    (DeviceManagerAsyncClient, transports.DeviceManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DeviceManagerClient, transports.DeviceManagerRestTransport, "rest", None),
])
def test_device_manager_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_device_manager_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_list_device_registries_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_device_registries(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_devices_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_devices(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_device_registry_rest_required_fields(request_type=device_manager.CreateDeviceRegistryRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_device_registry._get_unset_required_fields(jsonified_request)
...
def test_create_device_registry_rest_unset_required_fields():
    transport = transports.DeviceManagerRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_device_registry._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "deviceRegistry", )))
...
def test_create_device_registry_rest_interceptors(null_interceptor):
    transport = transports.DeviceManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DeviceManagerRestInterceptor(),
        )
    client = DeviceManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_create_device_registry") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_create_device_registry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.CreateDeviceRegistryRequest.pb(device_manager.CreateDeviceRegistryRequest())
        ...
        req.return_value._content = resources.DeviceRegistry.to_json(resources.DeviceRegistry())
        ...
        client.create_device_registry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_device_registry_rest_bad_request(transport: str = 'rest', request_type=device_manager.CreateDeviceRegistryRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_device_registry_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/registries" % client.transport._host, args[1])
...
def test_get_device_registry_rest_required_fields(request_type=device_manager.GetDeviceRegistryRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_device_registry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_device_registry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_get_device_registry") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_get_device_registry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.GetDeviceRegistryRequest.pb(device_manager.GetDeviceRegistryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_device_registry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_device_registry_rest_bad_request(transport: str = 'rest', request_type=device_manager.GetDeviceRegistryRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_device_registry_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/registries/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*}" % client.transport._host, args[1])
...
def test_update_device_registry_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'device_registry': {'name': 'projects/sample1/locations/sample2/registries/sample3'}}
...
def test_update_device_registry_rest_required_fields(request_type=device_manager.UpdateDeviceRegistryRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_device_registry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_device_registry_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("deviceRegistry", "updateMask", )))
...
def test_update_device_registry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_update_device_registry") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_update_device_registry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.UpdateDeviceRegistryRequest.pb(device_manager.UpdateDeviceRegistryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_device_registry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_device_registry_rest_bad_request(transport: str = 'rest', request_type=device_manager.UpdateDeviceRegistryRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_device_registry_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'device_registry': {'name': 'projects/sample1/locations/sample2/registries/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{device_registry.name=projects/*/locations/*/registries/*}" % client.transport._host, args[1])
...
def test_delete_device_registry_rest_required_fields(request_type=device_manager.DeleteDeviceRegistryRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_device_registry._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_device_registry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_delete_device_registry") as pre:
        pre.assert_not_called()
        pb_message = device_manager.DeleteDeviceRegistryRequest.pb(device_manager.DeleteDeviceRegistryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_device_registry(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_device_registry_rest_bad_request(transport: str = 'rest', request_type=device_manager.DeleteDeviceRegistryRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_device_registries_rest_required_fields(request_type=device_manager.ListDeviceRegistriesRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_device_registries._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_device_registries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_list_device_registries") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_list_device_registries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.ListDeviceRegistriesRequest.pb(device_manager.ListDeviceRegistriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.ListDeviceRegistriesResponse.to_json(device_manager.ListDeviceRegistriesResponse())
        ...
        client.list_device_registries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_device_registries_rest_bad_request(transport: str = 'rest', request_type=device_manager.ListDeviceRegistriesRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_device_registries_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(device_manager.ListDeviceRegistriesResponse.to_json(x) for x in response)
...
def test_create_device_rest_required_fields(request_type=device_manager.CreateDeviceRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_device_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "device", )))
...
def test_create_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_create_device") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_create_device") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.CreateDeviceRequest.pb(device_manager.CreateDeviceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_device_rest_bad_request(transport: str = 'rest', request_type=device_manager.CreateDeviceRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_device_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/registries/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/registries/*}/devices" % client.transport._host, args[1])
...
def test_get_device_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/registries/sample3/devices/sample4'}
    request = request_type(**request_init)
...
def test_get_device_rest_required_fields(request_type=device_manager.GetDeviceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_get_device") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_get_device") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.GetDeviceRequest.pb(device_manager.GetDeviceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_device_rest_bad_request(transport: str = 'rest', request_type=device_manager.GetDeviceRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_device_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/registries/sample3/devices/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*/devices/*}" % client.transport._host, args[1])
...
def test_update_device_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'device': {'name': 'projects/sample1/locations/sample2/registries/sample3/devices/sample4'}}
...
def test_update_device_rest_required_fields(request_type=device_manager.UpdateDeviceRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_update_device") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_update_device") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.UpdateDeviceRequest.pb(device_manager.UpdateDeviceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_device_rest_bad_request(transport: str = 'rest', request_type=device_manager.UpdateDeviceRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_device_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'device': {'name': 'projects/sample1/locations/sample2/registries/sample3/devices/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{device.name=projects/*/locations/*/registries/*/devices/*}" % client.transport._host, args[1])
...
def test_delete_device_rest_required_fields(request_type=device_manager.DeleteDeviceRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_delete_device") as pre:
        pre.assert_not_called()
        pb_message = device_manager.DeleteDeviceRequest.pb(device_manager.DeleteDeviceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_device_rest_bad_request(transport: str = 'rest', request_type=device_manager.DeleteDeviceRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_devices_rest_required_fields(request_type=device_manager.ListDevicesRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_devices._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_devices._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("device_ids", "device_num_ids", "field_mask", "gateway_list_options", "page_size", "page_token", ))
    jsonified_request.update(unset_fields)
...
def test_list_devices_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deviceIds", "deviceNumIds", "fieldMask", "gatewayListOptions", "pageSize", "pageToken", )) & set(("parent", )))
...
def test_list_devices_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_list_devices") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_list_devices") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.ListDevicesRequest.pb(device_manager.ListDevicesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.ListDevicesResponse.to_json(device_manager.ListDevicesResponse())
        ...
        client.list_devices(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_devices_rest_bad_request(transport: str = 'rest', request_type=device_manager.ListDevicesRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_devices_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(device_manager.ListDevicesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_modify_cloud_to_device_config_rest_required_fields(request_type=device_manager.ModifyCloudToDeviceConfigRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).modify_cloud_to_device_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_cloud_to_device_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "binaryData", )))
...
def test_modify_cloud_to_device_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_modify_cloud_to_device_config") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_modify_cloud_to_device_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.ModifyCloudToDeviceConfigRequest.pb(device_manager.ModifyCloudToDeviceConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = resources.DeviceConfig.to_json(resources.DeviceConfig())
        ...
        client.modify_cloud_to_device_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_modify_cloud_to_device_config_rest_bad_request(transport: str = 'rest', request_type=device_manager.ModifyCloudToDeviceConfigRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_modify_cloud_to_device_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*/devices/*}:modifyCloudToDeviceConfig" % client.transport._host, args[1])
...
def test_list_device_config_versions_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = device_manager.ListDeviceConfigVersionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_device_config_versions_rest_required_fields(request_type=device_manager.ListDeviceConfigVersionsRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_device_config_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_device_config_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_list_device_config_versions") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_list_device_config_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.ListDeviceConfigVersionsRequest.pb(device_manager.ListDeviceConfigVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.ListDeviceConfigVersionsResponse.to_json(device_manager.ListDeviceConfigVersionsResponse())
        ...
        client.list_device_config_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_device_config_versions_rest_bad_request(transport: str = 'rest', request_type=device_manager.ListDeviceConfigVersionsRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_device_config_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*/devices/*}/configVersions" % client.transport._host, args[1])
...
def test_list_device_states_rest_required_fields(request_type=device_manager.ListDeviceStatesRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_device_states._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_device_states_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_list_device_states") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_list_device_states") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.ListDeviceStatesRequest.pb(device_manager.ListDeviceStatesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.ListDeviceStatesResponse.to_json(device_manager.ListDeviceStatesResponse())
        ...
        client.list_device_states(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_device_states_rest_bad_request(transport: str = 'rest', request_type=device_manager.ListDeviceStatesRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_device_states_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*/devices/*}/states" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'resource': 'projects/sample1/locations/sample2/registries/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=projects/*/locations/*/registries/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=projects/*/locations/*/registries/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=projects/*/locations/*/registries/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_send_command_to_device_rest_required_fields(request_type=device_manager.SendCommandToDeviceRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).send_command_to_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_send_command_to_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_send_command_to_device") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_send_command_to_device") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.SendCommandToDeviceRequest.pb(device_manager.SendCommandToDeviceRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.SendCommandToDeviceResponse.to_json(device_manager.SendCommandToDeviceResponse())
        ...
        client.send_command_to_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_send_command_to_device_rest_bad_request(transport: str = 'rest', request_type=device_manager.SendCommandToDeviceRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_send_command_to_device_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/registries/*/devices/*}:sendCommandToDevice" % client.transport._host, args[1])
...
def test_bind_device_to_gateway_rest_required_fields(request_type=device_manager.BindDeviceToGatewayRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).bind_device_to_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_bind_device_to_gateway_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "gatewayId", "deviceId", )))
...
def test_bind_device_to_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_bind_device_to_gateway") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_bind_device_to_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.BindDeviceToGatewayRequest.pb(device_manager.BindDeviceToGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.BindDeviceToGatewayResponse.to_json(device_manager.BindDeviceToGatewayResponse())
        ...
        client.bind_device_to_gateway(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_bind_device_to_gateway_rest_bad_request(transport: str = 'rest', request_type=device_manager.BindDeviceToGatewayRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_bind_device_to_gateway_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/registries/*}:bindDeviceToGateway" % client.transport._host, args[1])
...
def test_unbind_device_from_gateway_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = device_manager.UnbindDeviceFromGatewayResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_unbind_device_from_gateway_rest_required_fields(request_type=device_manager.UnbindDeviceFromGatewayRequest):
    transport_class = transports.DeviceManagerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).unbind_device_from_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_unbind_device_from_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "post_unbind_device_from_gateway") as post, \
         mock.patch.object(transports.DeviceManagerRestInterceptor, "pre_unbind_device_from_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = device_manager.UnbindDeviceFromGatewayRequest.pb(device_manager.UnbindDeviceFromGatewayRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = device_manager.UnbindDeviceFromGatewayResponse.to_json(device_manager.UnbindDeviceFromGatewayResponse())
        ...
        client.unbind_device_from_gateway(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_unbind_device_from_gateway_rest_bad_request(transport: str = 'rest', request_type=device_manager.UnbindDeviceFromGatewayRequest):
    client = DeviceManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_unbind_device_from_gateway_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/registries/*}:unbindDeviceFromGateway" % client.transport._host, args[1])
