...
Device = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      name:
          The resource path name. For example, ``projects/p1/locations
          /us-central1/registries/registry0/devices/dev0`` or
      ...
      last_error_status:
          ...
          as a failure to publish to Cloud Pub/Sub. ‘last_error_time’ is
          the timestamp of this field. If no errors have occurred, this
          field has an empty message and the status code 0 == OK.
