...
UpdateDeviceRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      device:
          ...
          specify the name path. For example, ``projects/p0/locations
          /us-central1/registries/registry0/devices/device0``\ or
          ``projects/p0/locations/us-
          central1/registries/registry0/devices/{num_id}``.
      update_mask:
...
BindDeviceToGatewayRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      parent:
          ...
          /example-project/locations/us-central1/registries/my-
          registry``.
      gateway_id:
