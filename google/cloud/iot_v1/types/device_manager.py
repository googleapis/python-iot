...
class UpdateDeviceRequest(proto.Message):
    ...
    update_mask = proto.Field(proto.MESSAGE, number=3, message=gp_field_mask.FieldMask,)
...
class ListDevicesRequest(proto.Message):
    ...
    field_mask = proto.Field(proto.MESSAGE, number=4, message=gp_field_mask.FieldMask,)
